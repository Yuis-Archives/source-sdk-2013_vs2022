...
#define	MAX_MAP_ENTITIES				65536 // Mapbase: raised from 8192 (limit is compiler-only according to Ficool)
...
#define MAX_MAP_WORLDLIGHTS				65535 // Mapbase: raised from 8192 (limit is compiler-only according to Ficool)
#define MAX_MAP_CUBEMAPSAMPLES			1024
#define MAX_MAP_OVERLAYS				8912 // Mapbase: raised from 512 (limit is compiler-only according to Ficool)
